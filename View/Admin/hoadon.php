...
?>
            ...
            <form method="post" class="shadow p-4 rounded bg-light">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="tenTV" required  pattern="^[A-Za-zÀ-Ỷà-ỷĂăÂâÊêÔôƠơƯưĐđ\s]+$" 
                ...
                <div class="mb-3">
                    ...
                    <input type="Number" class="form-control" name="phoneNumber" required pattern="^\d{10,11}$"
                ...
                <div class="mb-3">
                    ...
                    <input type="Number" class="form-control" name="maTV" required pattern="^\d$"
                    title="Mã thành viên không hợp lệ, vui lòng nhập lại."/>
                </div>
                <div class="mb-3">
