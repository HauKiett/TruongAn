...
$id = (int)$_GET['id'];
$phieu = $conn->query("SELECT * FROM phieunhap WHERE id=$id")->fetch_assoc();
$ct = $conn->query("SELECT * FROM chitietphieunhap WHERE id_phieu=$id");

$pdf = new FPDF();
$pdf->AddPage();
$pdf->SetFont('Arial', 'B', 14);
$pdf->Cell(0, 10, 'PHIEU NHAP KHO', 0, 1, 'C');
$pdf->SetFont('Arial', '', 12);

$pdf->Cell(100, 10, 'Nha cung cap: ' . $phieu['nhacungcap'], 0, 1);
