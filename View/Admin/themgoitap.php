        ...
        <div class="main-container">
            ...
            <form method="post" class="shadow p-4 rounded bg-light">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="TenGoi" required pattern="[A-Za-z\u00C0-\u1EF9-_ ]+"
                        title="Chỉ được nhập chữ cái (có dấu hoặc không dấu), kí tự '-' hoặc '_', và khoảng trắng." />
                </div>
                <div class="mb-3">
                    <label for="GiaGoi" class="form-label">Giá Gói</label>
                    <input type="number" class="form-control" name="GiaGoi" required min="0" />
                </div>
                <div class="mb-3">
                    <label for="ThoiHanGoi" class="form-label">Thời Hạn Gói (Tháng)</label>
                    <input type="number" class="form-control" name="ThoiHanGoi" required min="0" />
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" name="soluongnguoithamgia" required min="0" />
                </div>
                <div class="text-end">
